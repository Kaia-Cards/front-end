...
function App() {
  ...
  return (
    <div className="app">
      <MaintenanceMode isActive={isMaintenanceMode} translations={t} />
      <CloseConfirmDialog 
            ...
            <>
              <div className="promo-banner">
                <div className="promo-content">
                  <h2 className="promo-title">{t.shop.title}</h2>
                  <p className="promo-subtitle">{t.shop.subtitle}</p>
